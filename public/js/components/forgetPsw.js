        ...
        return <div>
            ...
            <section className="content-box">
                <div className="left-area f1">
                    ...
                    <div className="input-item clearfix">
                        <input type="password" className="inputStyle" ref="password" placeholder="请输入6-16位密码" id="password"
                               onBlur={this.verifyPassword.bind(this)}onFocus={this.focusPassword.bind(this)} />
                        <span className="input-tips" id="passwordTip"></span>
                    </div>
                    <div className="input-item clearfix">
                        <input type="password" className="inputStyle" ref="confirmPassword" placeholder="请再次输入6-16位密码" id="confirmPassword"
                               onBlur={this.repeatPassword.bind(this)} onFocus={this.focusConfirm.bind(this)}/>
                        <span className="input-tips" id="repeatTip"></span>
                    </div>
                    <div>
                        <button type="submit" className="buttonType" onClick={this.forget.bind(this)} >确定</button>
                    </div>
                </div>
